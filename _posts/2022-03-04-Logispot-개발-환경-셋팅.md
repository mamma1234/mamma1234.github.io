...
JWT_SECRET=C8rWVLsNT9xKb2QLDmJiDIeFEB76zFZ9
JWT_SECRET=4KLGWLvRnEUwGRzztc06sqeuLBIjphkG


 This will invalidate all existing tokens. Are you sure you want to override the secret key? (yes/no) [no]:
 > y

jwt-auth secret [84fwjZxzodp3PJypoIIylJvN0OYaaI4z4QtcDX1bMsluYfiYGDNU12JAhI7OlvTV] set successfully.