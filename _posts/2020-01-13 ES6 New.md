...
화살표 함수의 더 자세한 설명은 MDN Arrow Functions 365를 참고하세요. printFriends() 함수의 선언 표기법이 궁금하시면 MDN Object Initializer 112를 참고하세요.
...
더 자세한 설명은 MDN Classes 446를 참고하세요.
...
더 자세한 설명은 MDN Grammar and types: Object literals 235를 참고하세요.
...
더 자세한 설명은 MDN Template literals 161를 참고하세요.
...
var [a = 1] = [];
a === 1;
더 자세한 설명은 MDN Destructuring assignment 219를 참고하세요.
...
f(...[1,2,3]) // 6
더 자세한 설명은 Default parameters 42, Rest parameters 79, Spread Operator 171를 참고하세요.
...
더 자세한 설명은 let statement 46, const statement 33를 참고하세요.
...
더 자세한 설명은 MDN for…of 80를 참고하세요.
...
더 자세한 설명은 MDN Iteration protocols 38를 참고하세요.
...
더 자세한 설명은 MDN RegExp.prototype.unicode 17를 참고하세요.
...
더 자세한 내용은 import statement 97, export statement 66를 참고하세요.
...
ws.add({ data: 42 });
wm.size // undefined (사용된 곳이 없기 때문)
더 자세한 내용은 MDN Map 51, Set 28, WeakMap 58, WeakSet 15를 참고하세요.
...
Object.keys(map); // ["b"]
더 자세한 내용은 ES6 In Depth: 심볼 (Symbol) 63를 참고하세요.
...
더 자세한 내용은 Number 7, Math 10, Array.from 13, Array.of 9, Array.prototype.copyWithin 6, Object.assign 15를 참고하세요.
...
더 자세한 내용은 MDN Promise 125를 참고하세요.
...
더 자세한 내용은 MDN Reflect 58를 참고하세요.
